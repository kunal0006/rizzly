    ...
    <main className="min-h-screen bg-background flex flex-col items-center justify-center p-6 selection:bg-primary/30 relative overflow-x-hidden">
      ...
      <div className="w-full max-w-md bg-white brutal-border rounded-3xl p-8 brutal-shadow relative z-10 mt-16 md:mt-0">
        ...
        <div className="text-center mb-8 border-b-4 border-black pb-6">
          <h1 className="text-3xl font-bold tracking-tight mb-2">NEW GAME</h1>
          <p className="font-bold text-sm uppercase">Create your player profile</p>
        </div>

        <div className="space-y-6">
          <Link href="/dashboard" className="w-full bg-white text-black font-bold brutal-border py-4 px-4 flex items-center justify-center gap-2 brutal-shadow-sm hover:-translate-y-1 transition-transform uppercase">
          ...
          <form className="space-y-6">
            ...
            <Link href="/dashboard" className="w-full bg-primary text-black font-bold py-4 px-4 flex items-center justify-center gap-2 brutal-border brutal-shadow-sm hover:-translate-y-1 transition-transform uppercase text-lg mt-4">
        ...
        <p className="text-center text-sm font-bold mt-8 border-t-4 border-black pt-6 uppercase">
          Already playing? <Link href="/login" className="text-secondary hover:text-pink-600 underline">Log in</Link>
        </p>
      </div>
    </main>
  );
