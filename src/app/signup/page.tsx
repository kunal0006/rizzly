  ...
  return (
    <main className="min-h-screen bg-background flex flex-col items-center justify-center p-6 selection:bg-primary/30 relative overflow-x-hidden">
      ...
      <div className="w-full max-w-md bg-white brutal-border rounded-3xl p-8 brutal-shadow relative z-10 mt-16 md:mt-0">
        ...
        {success ? (
          <div className="bg-primary p-6 brutal-border text-center space-y-4">
            <h2 className="font-bold text-xl uppercase">CHECK YOUR EMAIL!</h2>
            <p className="font-bold text-sm">We sent you a confirmation link. Click it to activate your account.</p>
          </div>
        ) : (
          <>
            <div className="space-y-6">
              ...
              <form onSubmit={handleEmailSignup} className="space-y-6">
                ...
                >
                  {loading ? "LOADING..." : "JOIN SERVER"} <ArrowRight className="w-5 h-5" />
                </button>
              </form>
            </div>
